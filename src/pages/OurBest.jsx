...
const OurBest = () => {
    return (
        <div className="bg-[#1b2316] px-4 py-10 lg:px-15 lg:py-20">
            ...
            {/* our product card */}
            <div className="mt-30 flex flex-col lg:flex-row justify-end  lg:h-[755px] rounded-[40px] lg:rounded-[92px] glass-effect  relative">
                {/* product image */}
                ...
                {/* right side section */}
                <div className=" sm:w-1/2 text-white/75 py-10 lg:py-30 px-5 mt-35 sm:mt-0 lg:px-20 boder ">
